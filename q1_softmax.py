...
def softmax(x):
    ...
    if len(x.shape) > 1:
        ...
        # using optimization in hw1(a), we can shift the input by a constant, which
        # is conveniently the max of an input row here to avoid numerical instabilities when
        # taking exponents of large numbers
